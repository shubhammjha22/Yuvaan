  ...
  return (
    <>
      <motion.div
        ...
        transition={{ duration: 1 }} // Duration of each transition
        className="leading-tight z-20 text-sm sm:text-xl w-[17rem] sm:w-[46rem] text-white font-abhaya mt-4 sm:mt-4 sm:font-lg"
      >
        <b className="text-xl mb-0 sm:text-2xl">{textContent[index].title}</b>{" "}
        <br />
